...
- **[SMART ECONOMY] Gamified Dashboard:** Meliputi _Leaderboard_ warga, _Milestone_ pencapaian lingkungan, dan pusat penukaran poin (Rewards).
...
- **Routing:** Client-side routing dengan prop drilling (untuk demo)
- **Mock Data:** JSON mock data untuk simulasi
